...
\mySubHeadingListStart
  ...
  {\faIcon{building} NASA (Contractor)}{Kennedy Space Center, FL, USA}
    \myItemListStart
      ...
      \myItem{Drafted Change Requests and Operations & Maintainability Requirements and Specifications (OMRS) from stakeholder reviews, and guided the updates through board approval following comment disposition.}
